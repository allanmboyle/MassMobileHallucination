...
var SAMPLING_INTERVAL = 1000; //collect metrics every 10 seconds
var countNumberRequests = 0;



var UPDATE_FREQUENCY = 1000; // milliseconds between updates of player states to playfield
...
module.exports = {
    ...
    sendCustomMessage: function (id, message, data) {
        console.log("playfield: sending message: " + message + " with data: " + data + " from client " + id);
        connections.playfield.emit(message, data);
    },
