...
module.exports = {
	...
	emit: function (message, data) {
		// NOTE TO SELF: this will always be this connection, even if no playfields have connected yet
		// (this is different to how I had it before with a single socket - der fred)
		connections.playfield.emit(message, data);
//		} else {
//			// There is no playfield connection yet. Log & Ignore.
//			console.log("A player has connected but there is no playfield yet!");
//		}
	},
